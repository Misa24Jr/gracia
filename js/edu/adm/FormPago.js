...
var FormPago = {
	...
	dialogsFormPago_Init : function() {
		...
		editsFormPagMonPagar.setSizeEdit(183);
		editsFormPagMonPagar.setMaxLength(8);
		dialogsFormPago.addObject(editsFormPagMonSalFavor,20,68);
		editsFormPagMonSalFavor.setSizeEdit(183);
		editsFormPagMonSalFavor.setMaxLength(8);		
		dialogsFormPago.addObject(editsFormPagResta,20,95);
		editsFormPagResta.setSizeEdit(183);
		editsFormPagResta.setMaxLength(8);		
		dialogsFormPago.addObject(pcbFormPagForPago,20,122);
		//dialogsFormPago.addObject(pcbFormPagBanOrigen,260,65);
		//pcbFormPagBanOrigen.setWidthCombo(207);
		dialogsFormPago.addObject(editsFormPagReferencia,20,149);
		editsFormPagReferencia.setSizeEdit(183);
		editsFormPagReferencia.setMaxLength(20);		
		dialogsFormPago.addObject(pcbFormPagBanDestino, 20, 176);
		pcbFormPagBanDestino.setWidthCombo(171);		
		dialogsFormPago.addObject(calendarFormPagfecha.getEditCalendar(), 20,203);
		dialogsFormPago.addObject(editsFormPagMonto,20,233);
		dialogsFormPago.addObject(editsFormPagMontoDolar,210,233);
		editsFormPagMonto.setSizeEdit(70);
		editsFormPagResta.setMaxLength(8);		
		dialogsFormPago.addObject(imagesFormPagAnaPago, 185, 233);
		imagesFormPagAnaPago.setSize(19,19);		
		dialogsFormPago.addObject(gridsFormPago.getObject(),0,270);				
		dialogsFormPago.addObject(pcbFormPagTipDocumento,20,400);
		dialogsFormPago.addObject(labelsFormPagObservaciones,20,433);
		labelsFormPagObservaciones.setFont('arial','12','Black');		
		dialogsFormPago.addObject(memoFormPagObservaciones, 20,449);
		dialogsFormPago.addObject(imgButtonsFormPagPagar, 30, 479);
		dialogsFormPago.addObject(imgButtonsFormPagLimpiar, 130, 479);
		dialogsFormPago.addObject(imgButtonsFormPagSalir, 230, 479);		
	},
	...
	gridsFormPago_Init : function() {
        ...
        gridsFormPago.setSizeCol(1,20);
        gridsFormPago.setSizeCol(2,181);
        gridsFormPago.setSizeCol(3,0);
        gridsFormPago.setSizeCol(4,0);
        gridsFormPago.setSizeCol(5,112);
		...
		gridsFormPago.hideCol(3);
		gridsFormPago.hideCol(4);
		...
		create : function() {
		dialogsFormPago = dialogs.create('dialogsFormPago',0,0,318,485,'FORMA DE PAGO');
		dialogsFormPago.setAdjY(60);
		dialogsFormPago.setEnableMinimize(false);		
		editsFormPagMonPagar = edits.create('editsFormPagMonPagar','editsFormPagMonPagar','Total a Pagar:',1,95,'normal');
		editsFormPagMonPagar.setValidEmpty();
		editsFormPagMonPagar.readOnly(true);
		editsFormPagMonPagar.setValidReal();
		editsFormPagMonSalFavor = edits.create('editsFormPagMonSalFavor','editsFormPagMonSalFavor','Saldo a Favor:',1,95,'normal');
		editsFormPagMonSalFavor.setValidEmpty();
		editsFormPagMonSalFavor.readOnly(true);
		editsFormPagMonSalFavor.setValidReal();
		editsFormPagResta = edits.create('editsFormPagResta','editsFormPagResta','Resta:',1,95,'normal');
		editsFormPagResta.setValidEmpty();
		editsFormPagResta.readOnly(true);
		editsFormPagResta.setValidReal();
		pcbFormPagForPago = powerComboBox.create('pcbFormPagForPago', 'pcbFormPagForPago', 'Forma de Pago:', 1,91);
		pcbFormPagForPago.setWidthCombo(171);
	    ...
	    calendarFormPagfecha.setWidthEditCalendar(149);
        calendarFormPagfecha.setCaption('Fecha Ref.:',1,95);
        calendarFormPagfecha.sendToFrom(140);
		...
		editsFormPagMonto = edits.create('editsFormPagMonto','editsFormPagMonto','Monto Bs:',1,95,'normal');
		editsFormPagMonto.setValidReal();
        editsFormPagMontoDolar = edits.create('editsFormPagMontoDolar', 'editsFormPagMontoDolar', 'M.$.:', 1,30, 'normal');    
        editsFormPagMontoDolar.setValidReal();
		editsFormPagMontoDolar.setSizeEdit(55);
		editsFormPagMontoDolar.setMaxLength(12);
		editsFormPagReferencia = edits.create('editsFormPagReferencia','editsFormPagReferencia','Referencia:',1,95,'normal');
		editsFormPagReferencia.setValidEmpty();
		pcbFormPagBanDestino = powerComboBox.create('pcbFormPagBanDestino', 'pcbFormPagBanDestino', 'Banco Destino:', 1,91);
		...
		hint.addToHintWithRefreshPos(imagesFormPagAnaPago, dialogsFormPago,"Incluir forma de pago",85,225,false,true);		
		...
		memoFormPagObservaciones.setDimension(270, 15);
		memoFormPagObservaciones.setMaxLength(110);
		memoFormPagObservaciones.setValidEmpty();
		pcbFormPagTipDocumento = powerComboBox.create('pcbFormPagTipDocumento', 'pcbFormPagTipDocumento', 'Tipo Documento:', 1,100);
		pcbFormPagTipDocumento.setWidthCombo(161);
		pcbFormPagTipDocumento.enableReadOnlyEditor();
		pcbFormPagTipDocumento.addEmptyOption();
		pcbFormPagTipDocumento.setValidEmpty();
		imgButtonsFormPagPagar = imgButtons.create('imgButtonsFormPagPagar','Pagar','abonos_2.png');
		...
		imgButtonsFormPagPagar.setDimension(60,22);
		imgButtonsFormPagLimpiar.setDimension(60,22);
		imgButtonsFormPagSalir.setDimension(60,22);
	},
	...
	calcAddFrmPago : function() {
		editsFormPagResta.setValue((parseFloat(editsFormPagResta.getValue()) - parseFloat(parseFloat(editsFormPagMonto.getValue())).toFixed(2)));
	...
	setData : function() {	
		if(gridsFormPago.getDataCell(1) != '') {	
			...
			if(gridsFormPago.getDataCell(2)=="SALDO A FAVOR") {
			  ...
			  pcbFormPagForPago.setSelectedIndex(0);
			  editsFormPagMonto.readOnly(false);
			  editsFormPagResta.setValue((parseFloat(editsFormPagResta.getValue()) + parseFloat(parseFloat(editsFormPagMonSalFavor.getValue())).toFixed(2)));
			}
			else {
				editsFormPagResta.setValue((parseFloat(editsFormPagResta.getValue()) + parseFloat(parseFloat(editsFormPagMonto.getValue())).toFixed(2)));
			}
	...
	setEvents : function() {
        ...
        editsFormPagMontoDolar.onEnter(this.windowName + ".capturar()");
        
        editsFormPagMonto.onKeyUp(this.windowName + ".setMontoD()");
        editsFormPagMonto.onBlur(this.windowName + ".setMontoD()");
        editsFormPagMonto.onEnter(this.windowName + ".capturar()");
