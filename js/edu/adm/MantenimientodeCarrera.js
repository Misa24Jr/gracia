...
var MantenimientodeCarrera = {
    ...
    dialogsMantCarrera_Init: function(){
		...
		dialogsMantCarrera.adjAllMarginObj(3,1,37);
        
        ////DEFINIR FORMA DE CARGA DE ESTOS DATOS
		...
		*/
		...
		dialogsMantCarrera.setHeightCell(8,1,12);  
        ...
        dialogsMantCarrera.leftMarginObj(11,1,0,107);
    },
	
    gridsMantCarrera_Init: function(){
        gridsMantCarrera.setFixColRow(false, true);
        gridsMantCarrera.addTitleVectorX(['id_suborg','de_suborg','id_carrera','Nombre del Servicio','Departamentos','id_nvl_acad','Nivel Academico','titulo','idSubSis','undPos']);
        gridsMantCarrera.showData();
        gridsMantCarrera.setSizeCol(1, 0);
        gridsMantCarrera.setSizeCol(2, 0);
        gridsMantCarrera.setSizeCol(3, 0);
        gridsMantCarrera.setSizeCol(4, 732);
        ...
        gridsMantCarrera.hideCol(5);
        gridsMantCarrera.hideCol(6);
		gridsMantCarrera.hideCol(7);
    ...
    create: function(){
        dialogsMantCarrera = dialogs.create('dialogsMantCarrera', 0, 0, 774, 406, 'SERVICIOS');
		...
		powerComboBoxMantCarOrganizacion.setWidthCombo(193);
        powerComboBoxMantCarSubOrganizacion = powerComboBox.create('powerComboBoxMantCarSubOrganizacion', 'powerComboBoxMantCarSubOrganizacion', 'Suborganización (^):', 1,133);
        ...
        powerComboBoxMantCarSubOrganizacion.setWidthCombo(218);
		editsMantCarNomCarrera = edits.create('editsMantCarNomCarrera', 'editsMantCarNomCarrera', 'Nombre / Servicio :', 1,137, 'normal');
        editsMantCarNomCarrera.setValidEmpty();
        editsMantCarNomCarrera.setSizeEdit(200);
		...
		editsMantCarNomDepartamento.setSizeEdit(220);
        ...
        powerComboBoxMantCarNivAcademico.setWidthCombo(200);
        ...
        gridsMantCarrera = grids.create('gridsMantCarrera', 13, 10);
